  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        <p>
          Upon successfully completing the Machine Learning Mastery course, you
          will be required to take a final assessment to qualify for
          certification. This assessment evaluates your understanding of machine
          learning concepts, techniques, and applications covered in the course.
          It is conducted under structured guidelines to ensure fairness and
          integrity.
        </p>
        <p>
          ...
          complete practice problems and real-world projects to reinforce their
        ...
        <p>
          ...
          for the Machine Learning Mastery course. If you do not achieve the
...
export default CertificationProcessML;
