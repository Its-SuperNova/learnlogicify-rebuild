...
const Card = (props: Props) => {
  ...
  return (
    <div className="h-auto max-h-[340px] w-full  p-2 border border-gray-300 rounded-[17px] flex flex-col items-center pb-0 transition-all duration-300 relative hover:shadow-lg hover:-translate-y-1 cursor-pointer">
      {/* Banner */}
      <div
