...
export const CourseData = [
...

  {
    ...
    problemsCount: "150+ Exercises",
    projectsCount: "5+ Real-World Node.js Projects",
    portalAccess: "LMS Portal Access (6 Months)",
    sessionRecordings: "Session Recordings in LMS",
    certificate: "Certificate of Completion",
    originalPrice: 7999,
    ...
    aboutData: {
      description: [
        "The Node.js Mastery course is designed to provide a deep understanding of back-end development using Node.js. You'll learn to build robust and scalable server-side applications, work with databases, handle authentication, and deploy applications efficiently.",
        "Through hands-on projects, real-world exercises, and best practices, you'll master Express.js, databases (MongoDB & PostgreSQL), REST & GraphQL APIs, authentication, and microservices architecture. By the end of this course, you'll be able to build high-performance applications and confidently work as a backend developer.",
      ],
      structure: [
        "Weekdays: 1.5 Hours per Day",
        "Weekends: 3 Hours per Day",
    ...
    prerequisites: [
      {
        text: "Before starting this course, you should have a solid understanding of JavaScript ES6+, including asynchronous programming (Promises, Async/Await). Basic knowledge of databases and APIs will be beneficial. If needed, we recommend reviewing the following courses:",
        links: [
          {
            link: "/course/pages/js-fundamentals",
            linkText: "JavaScript Fundamentals",
    ...
    certificateData: {
      ...
      title: "Certificate of Excellence",
      description:
        "Upon successfully completing the course, you will be awarded the Certificate of Excellence from LearnLogicify Technologies. This certification validates your expertise in backend development with Node.js, showcasing your ability to build, optimize, and deploy production-grade applications.",
      certificateLink: "/images/certificate/c-1.png",
    },
    certificationProcessData: {
      title: "Certification Process and Requirements",
      description: [
        "To earn certification, you must complete all course modules and pass the final assessment. The assessment evaluates your ability to build and deploy real-world Node.js applications with proper authentication, database integration, and API management.",
      ],
      assessmentDetails:
        "The final assessment consists of a project-based evaluation and coding exercises, making up 100% of your certification score.",
      criteriaTitle: "Certification Eligibility Criteria",
      ...
      retakeInfo:
        "One retake opportunity is available if the minimum score is not achieved.",
      finalNote:
        "This certification confirms your ability to build scalable and maintainable Node.js applications.",
    },
    faqData: [
      {
        title: "What is the format of this course?",
        description:
          "Node.js Mastery is a live online training program with interactive sessions, hands-on projects, and real-world exercises.",
      },
      {
        title: "Do I need prior JavaScript experience?",
        description:
          "Yes, familiarity with JavaScript ES6+ features, including async/await, is recommended before taking this course.",
      },
      {
        title: "Will I have access to recorded sessions?",
        description:
      ...
      },
      {
        title: "What projects will I work on?",
        description:
          "You will work on real-world projects, including building RESTful and GraphQL APIs, authentication systems, and microservices architecture.",
      },
      {
        title: "How long is the course and what is the schedule?",
        description:
          "The course includes 100+ hours of training with live interactive sessions, scheduled for 1.5-hour sessions on weekdays and 3-hour sessions on weekends.",
      },
      {
        title: "Do I receive a certificate upon completion?",
        description:
      ...
      {
        title: "Will I learn how to deploy my Node.js apps?",
        description:
          "Yes! The course covers deployment strategies, including deploying applications on cloud platforms like AWS and Vercel.",
      },
    ],
    syllabusData: [
      {
      ...
      },
      {
        icon: "FaBoxOpen",
        title: "Module 3",
        subtitle: "Node Package Manager (NPM)",
        topics: [
          "Introduction",
          "Package.json",
      ...
      },
      {
        icon: "FaServer",
        title: "Module 4",
        subtitle: "Building RESTful APIs with Express",
        topics: [
          "Introduction",
          "RESTful Services",
          "Introducing Express",
      ...
      },
      {
        icon: "FaTasks",
        title: "Module 5",
        subtitle: "Express - Advanced Topics",
        topics: [
          "Introduction",
          "Middleware",
      ...
      },
      {
        icon: "FaDatabase",
        title: "Module 7",
        subtitle: "CRUD Operations Using Mongoose",
        topics: [
          "Introducing MongoDB",
      ...
      },
      {
        icon: "FaCheckCircle",
        title: "Module 8",
        subtitle: "Mongo - Data Validation",
        topics: [
          "Validation",
          "Built-in Validators",
          "Custom Validators",
      ...
      },
      {
        icon: "FaLink",
        title: "Module 9",
        subtitle: "Mongoose - Modeling Relationships between Connected Data",
        topics: [
      ...
      },
      {
        ...
        title: "Module 15",
        subtitle: "Handling and Logging Errors",
        topics: [
          "Introduction",
  ...
  },
  {
    ...
    topicsCount: "12 Modules",
    problemsCount: "120+ Exercises",
    projectsCount: "4+ Real-World Django Projects",
    portalAccess: "LMS Portal Access (6 Months)",
    sessionRecordings: "Session Recordings in LMS",
    certificate: "Certificate of Completion",
    originalPrice: 7999,
    ...
    aboutData: {
      description: [
        "Ultimate Django is a comprehensive course designed to help you master Django, a powerful Python web framework. You'll start from the basics of web development with Django and progress to building robust, scalable, and secure web applications. The course covers key concepts such as models, views, templates, forms, authentication, REST APIs, and deployment.",
        "With hands-on projects, practical exercises, and real-world scenarios, you'll gain expertise in developing web applications, optimizing performance, and implementing best practices. By the end of this course, you'll be able to create feature-rich web applications using Django and deploy them confidently to production.",
      ],
      structure: [
        "Weekdays: 1.5 Hours per Day",
        "Weekends: 3 Hours per Day",
    ...
    prerequisites: [
      {
        text: "Before enrolling in this course, it is strongly recommended to have a basic understanding of Python programming. You should be comfortable with Python syntax, data structures, functions, and basic OOP concepts. If you're new to Python or need a refresher, we recommend completing our Python Programming course first.",
        links: [
          {
            link: "/course/pages/python-programming",
            linkText: "Python Programming",
    ...
    certificateData: {
      ...
      title: "Certificate of Excellence",
      description:
        "Upon successfully completing the course, you will be awarded the Certificate of Excellence from LearnLogicify Technologies, validating your proficiency in Django web development. This certification demonstrates your ability to build scalable web applications, implement best practices, and handle deployment, enhancing your career opportunities in web development.",
      certificateLink: "/images/certificate/c-1.png",
    },
    certificationProcessData: {
      title: "Certification Process and Requirements",
      description: [
        "To earn certification, you must complete all course modules and pass the final assessment.",
        "The final assessment will include building a complete Django application, coding challenges, and theoretical questions.",
      ],
      assessmentDetails:
        "The final assessment consists of a 100-mark evaluation, with a minimum passing score of 60%.",
      criteriaTitle: "Certification Eligibility Criteria",
      ...
      retakeInfo:
        "You will have one opportunity to retake the final assessment if needed.",
      finalNote:
        "This certification validates your Django development expertise and hands-on skills, making you ready for professional development roles.",
    },
    faqData: [
      {
        title: "What is the format of this course?",
        description:
          "Ultimate Django is a live online training program with interactive sessions, real-world projects, and hands-on coding exercises.",
      },
      {
        title: "Do I need prior Django experience?",
        description:
          "No prior Django experience is required. However, basic knowledge of Python is strongly recommended.",
      },
      {
        title: "Will I have access to recorded sessions?",
        description:
      ...
      },
      {
        title: "What projects will I work on?",
        description:
          "You will work on real-world Django projects including blog platforms, e-commerce sites, and RESTful APIs.",
      },
      {
        title: "How long is the course and what is the schedule?",
        description:
    ...
    syllabusData: [
      ...
      },
      {
        icon: "FaDatabase",
        title: "Module 2",
        subtitle: "Building a Data Model",
        topics: [
      ...
      },
      {
        ...
        topics: [
          ...
          "Grouping Data and Querying Generic Relationships",
          "Custom Managers",
          "Understanding QuerySet Cache",
          "Creating, Updating, and Deleting Objects",
          "Transactions and Executing Raw SQL Queries",
        ],
      },
      {
        icon: "FaTools",
        ...
        topics: [
          ...
          "Adding Search & Filtering to the List Page",
      ...
      },
      {
        icon: "FaCode",
        title: "Module 6",
        subtitle: "Building RESTful APIs with Django REST Framework",
        topics: [
          ...
          "Custom Serializer Fields & Relationships",
          "Model Serializers",
          "Validating Data",
      ...
      },
      {
        icon: "FaServer",
        title: "Module 7",
        subtitle: "Advanced API Concepts",
        topics: [
          "Class-based Views",
      ...
      },
      {
        icon: "FaShoppingCart",
        title: "Module 8",
        subtitle: "Designing and Implementing a Shopping Cart API",
        topics: [
          "Designing the API",
          "Revisiting the Data Model",
          "Creating a Cart",
          "Getting a Cart & Cart Items",
      ...
      },
      {
        icon: "FaUserLock",
        title: "Module 9",
        subtitle: "Django Authentication System",
        topics: [
      ...
      },
      {
        icon: "FaLock",
        title: "Module 10",
        subtitle: "Securing APIs",
        topics: [
          "Token-based Authentication",
          "Adding the Authentication Endpoints",
          "Registering Users",
          "Building the Profile API",
          "Logging In & Inspecting a JSON Web Token",
          "Refreshing Tokens",
          "Getting the Current User & Profile",
          "Applying Permissions",
          "Custom Model & Object Permissions",
        ],
      },
      {
        icon: "FaCloud",
        title: "Module 11",
        subtitle: "Deploying Django Applications",
        topics: [
          "Preparing the App for Production",
          "Getting Started with Heroku",
          "Adding Code to a Git Repository",
          "Deploying to Heroku",
          "Viewing Logs & Setting Environment Variables",
      ...
      },
      {
        icon: "FaBug",
        title: "Module 12",
        subtitle: "Testing and Debugging Django Applications",
        topics: [
      ...
      },
      {
        icon: "FaShoppingCart",
        title: "Module 13",
        subtitle: "Designing and Building the Orders API",
        topics: [
          "Introduction",
          "Designing the API",
          "Getting the Orders",
      ...
      },
      {
        icon: "FaTasks",
        title: "Module 16",
        subtitle: "Running Background Tasks",
        topics: [
          "Introduction",
