...
import { FaBoxOpen, FaBrain, FaBug, FaBuilding, FaCalculator, FaCamera, FaChartBar, FaChartLine, FaChartPie, FaCheckCircle, FaClipboardCheck, FaClock, FaCloud, FaCloudDownloadAlt, FaCloudUploadAlt, FaCode, FaCodeBranch, FaCogs, FaColumns, FaCss3Alt, FaCubes, FaDatabase, FaEdit, FaEnvelope, FaExclamationTriangle, FaEye, FaFileArchive, FaFilm, FaFilter, FaFlask, FaFont, FaGamepad, FaGlobe, FaHtml5, FaImages, FaJava, FaJs, FaJsSquare, FaKey, FaLanguage, FaLink, FaLock, FaNetworkWired, FaNodeJs, FaPaintBrush, FaPalette, FaPlay, FaProjectDiagram, FaPython, FaQuestion, FaReact, FaRegFolderOpen, FaRegObjectGroup, FaRoad, FaRobot, FaRoute, FaServer, FaShoppingCart, FaSyncAlt, FaTachometerAlt, FaTasks, FaTools, FaTrash, FaTree, FaUpload, FaUserLock, FaUserShield, FaUserTag, FaVial, FaWpforms } from "react-icons/fa";
