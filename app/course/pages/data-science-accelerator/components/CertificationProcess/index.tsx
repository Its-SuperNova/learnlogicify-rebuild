  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        <p>
          Upon successfully completing the Data Science Accelerator course, you
          will be required to take a final assessment to qualify for
          certification. The assessment evaluates your understanding of data
          science concepts, tools, and real-world applications covered in the
          course. It is conducted under structured guidelines to ensure fairness
          and integrity.
        </p>
        <p>
          ...
          exercises and projects throughout the course to reinforce their
          learning, but these do not contribute to the final certification
          score.
        </p>
        <p>
        ...
        <p>
          ...
          for the Data Science Accelerator course. If you do not achieve the
...
export default CertificationProcessDS;
